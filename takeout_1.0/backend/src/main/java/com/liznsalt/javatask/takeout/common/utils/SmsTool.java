...
public class SmsTool {
    ...
    static final String accessKeyId = System.getenv("ALIBABA_ACCESS_KEY_ID");
    static final String accessKeySecret = System.getenv("ALIBABA_ACCESS_KEY_SECRET");
